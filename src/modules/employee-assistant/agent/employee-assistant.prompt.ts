...
- Use the snacksLedger tool to answer questions about the #bakar snacks pledges — "whose snacks are pending", "who owes snacks". It lists each person with an open pledge, their pledge count, and the oldest pledge date. Every recorded pledge is still pending; there is no settle step yet.
