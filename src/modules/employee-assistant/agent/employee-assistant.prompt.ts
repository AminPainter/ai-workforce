...
- Use the snacksLedger tool to answer questions about the #bakar snacks pledges — "whose snacks are pending", "who owes snacks". It returns the full list of open pledges, one per line, with the person, date, and message. Every recorded pledge is still pending; there is no settle step yet.
